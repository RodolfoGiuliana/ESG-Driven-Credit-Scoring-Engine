...
st.set_page_config(
    page_title="FinScore AI | Rodolfo Giuliana",
    layout="wide"
)
...
input_data = {
    ...
    "ebitda": ebitda,
    "servizio_debito": servizio_debito
}
...
st.info(
    "Nota tecnica: Il modello utilizza una ponderazione variabile tra indicatori di bilancio "
    "e score di sostenibilità, in linea con le normative EBA 2026."
)
